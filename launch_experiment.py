...
from rlkit.torch.networks import FlattenMlp, MlpEncoder, RecurrentEncoder, VectorQuantize, SelfAttnEncoder
...
def experiment(variant, seed=None):
    ...
    VectorQuantizeCodebook = VectorQuantize(
        ...
        codebook_size=variant['util_params']['codebook_size'],
...
def main(config, gpu, seed=0, exp_name=None,
    ...
    variant['util_params']['codebook_size'] = codebook_size
